...
TEST(Spectrum, MaxValue) {
    ...
    Float lambda_arr[5] = {Float(300), Float(380), Float(510), Float(662), Float(700)};
    std::span<Float> lambda_(lambda_arr);
    Float v_arr[5] = {Float(1.5), Float(2.6), Float(10.1), Float(5.3), Float(7.7)};
    std::span<Float> v_(v_arr);

    EXPECT_EQ(10.1f,(PiecewiseLinearSpectrum(lambda_, v_).MaxValue()));
